...
class Welcome extends CI_Controller {
	...
	public function mis_notificaciones()
	{
        ...
        //$data['convenios'] = $this->functions->notificaciones_convenio($this->session->id, 1);
		$this->load->view('frontend/includes/header');
...
/******************************************************************************************************************************************/
	...
	public function enviar_oferta()
	{
		...
		self::guardar_notificacion_persona($id_cliente, 'Te ha enviado una oferta a un requerimiento');
	...
	public function enviar_correo_oferta($email, $nombre, $oferta)
	{
            ...
            $this->email->to($email);
            $this->email->subject('Tienes una oferta en tu requerimiento');
