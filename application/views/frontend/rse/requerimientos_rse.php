...
<ol class="breadcrumb">
  ...
  <li class="active">Listado de requerimientos RSE</li>
</ol>
<br>

<div class="col-sm-12 box-separator">
  <h1 class="gray titulo-int">LISTADO DE REQUERIMIENTOS RSE</h1>
  <br>
      ...
      <div class="row" id="filter">
        <form method="post">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 filter-input">
            <select class="form-control" name="region" id="region">
              ...
              <?php foreach($this->functions->listarRegiones() as $r){ ?>
                <option <?php if($region == $r->id_region){ echo 'selected'; } ?> data-id="<?= $r->id_region;?>" value="<?= $r->id_region;?>">
                  <?= $r->nombre_region;?>
                </option>
              <?php } ?>
            </select>
          ...
          <div class="col-lg-3 col-md-2 col-sm-6">
            <a href="<?= base_url();?>requerimientos_rse" class="btn btn-danger" style="width: 100%;">Eliminar filtros</a>
          </div>
        </form>
      </div>
      ...
      <div class="row">
          ...
          <table class="table table-stripped table-condensed" style="font-size: 12px;">
            ...
            <?php foreach ($requerimientos as $r) { ?>
              ...
              <tr style="font-size: 13px;">
                ...
                <td>
                  <a href="<?= base_url();?>perfil_rse/<?= $r->id_empresa;?>">
                    <?= $r->nombre_empresa;?>
                  </a>
                </td>
        ...
        <?php } else { echo '<br><p class="alert alert-danger">La búsqueda no arrojó resultados</p>'; } ?>
