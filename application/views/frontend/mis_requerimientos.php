  ...
  <div class="row">
    <div class="col-lg-12">
      <ol class="breadcrumb">
        ...
        <li class="active">Listado de Solicitudes de Cotizaciones ingresadas por mí</li>
      </ol>
      <hr>
    </div>
  ...
  <div class="row"> <br>
    ...
    <div class="col-sm-12">
      ...
      <div class="col-sm-9 box-separator">
        <h1>
          Listado de Solicitudes de Cotizaciones ingresadas por mí
          <br>
        <a href="<?= base_url();?>agregar_requerimiento" class="btn btn-default pull-right">+ Ingresar Solicitud de Cotizaciones</a>
        </h1>
        <br><br>

        <?php if(count($requerimientos) == 0){ ?>
          <p>No tienes solicitudes de cotizaciones ingresadas</p>
        <?php } else { ?>
          ...
          <table class="table table-stripped" style="font-size: 12px;">
            ...
            <?php foreach ($requerimientos as $r) { ?>
              ...
              <tr>
                ...
                <td>
                  <a href="<?= base_url();?>ofertas_requerimiento/<?= $r->id_requerimiento;?>" style="text-decoration: none;">
                    <span class="label label-warning">
                      ver <?= $this->functions->contar_ofertas($r->id_requerimiento);?> cotizacion(es)
                    </span>
                  </a>
                </td>
                ...
                <?php if($r->estado_requerimiento == 1){ ?>
                 <a href="#r_<?= $r->id_requerimiento;?>" data-toggle="modal" class="delete">Editar</a>
                 <br>
                 <a href="#c_<?= $r->id_requerimiento;?>" data-toggle="modal" class="delete">Cerrar</a>
                 <?php } ?>
                </td>
              </tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <h2 class="modal-title">Editar Solicitud</h2>
                  </div>
          ...
          <div id="c_<?= $r->id_requerimiento;?>" class="modal fade" tabindex="-1" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h2 class="modal-title">Cerrar Solicitud</h2>
                  </div>
                  <div class="modal-body">
                  <div class="clearfix"></div>
                    <div class="col-lg-12">
                      <p>Ingrese el motivo por el cual va a cerrar la Solicitud</p>
                  ...
                  <div class="modal-footer">
                    ...
                    <div class="col-md-12">
                        <br>
                        <button type="button" data-id="<?= $r->id_requerimiento;?>" class="btn btn-default close_req">Cerrar Solicitud</button>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-sm-3">
        <div class="box-separator">
          <div class="box-lateral">
            <h2 style="font-size: 18px;">Podrías querer seguir a:</h2>
            <br>
