<div class="container">
  ...
  <br>
    ...
    <!--FIN lateral-->
      ...
      <div class="col-md-9 box-separator">
        <div class="row">
          <div class="col-sm-9">
            <ol class="breadcrumb">
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <div class="col-sm-6">
                <!--<h5>Cínica Dental</h5>-->
                <h2 style="min-height: 90px;"><a style="color: #0dcbab !important;" href="<?= base_url();?>microempresarios/detalle/<?= $tipo;?>/<?= $m->id_empresa;?>/<?= $madre;?>"><?= $m->nombre_empresa;?></a></h2>
                ...
                <br>
                <p><a class="nacho-title" href="<?= base_url();?>microempresarios/detalle/<?= $tipo;?>/<?= $m->id_empresa;?>/<?= $madre;?>">Ver más</a></p>
              </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <h2 class="modal-title">Listado de personas que recomiendan a <b style="color: #0dcbab !important;"><?= $m->nombre_empresa?></b></h2>
                  </div>
          ...
          <div id="seguir-<?= $m->id_empresa;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h2 class="modal-title">Listado de seguidores de <b style="color: #0dcbab !important;"><?= $m->nombre_empresa?></b></h2>
                  </div>
                  <div class="modal-body">
                  <div class="clearfix"></div>
                    <div class="col-lg-12">
